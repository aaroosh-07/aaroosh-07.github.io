        ...
        <>
            ...
            <div className="skill-grid">
                ...
                <div className="skills">
                    ...
                    <p className="skills-description">HTML</p>
                </div>
                ...
                <div className="skills">
                    ...
                    <p className="skills-description">CSS</p>
                </div>
                ...
                <div className="skills">
                    ...
                    <p className="skills-description">GITHUB</p>
                </div>

                <div className="skills">
                    <p className="skills-description">PYTHON</p>
                </div>

                <div className="skills">
                    <p className="skills-description">DJANGO</p>
                </div>

                <div className="skills">
                    <p className="skills-description">FLASK</p>
                </div>
            </div>
        </>
    );
